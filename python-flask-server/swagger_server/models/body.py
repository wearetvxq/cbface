...
class Body(Model):
    ...
    def __init__(self, username: str=None, passwd: str=None):  # noqa: E501
        ...
        :type username: str
        :param passwd: The passwd of this Body.  # noqa: E501
        :type passwd: str
        """
        self.swagger_types = {
            'username': str,
    ...
    @property
    def passwd(self) -> str:
        """Gets the passwd of this Body.

        password  # noqa: E501

        :return: The passwd of this Body.
        :rtype: str
        """
        return self._passwd
    ...
    def passwd(self, passwd: str):
        """Sets the passwd of this Body.

        password  # noqa: E501

        :param passwd: The passwd of this Body.
        :type passwd: str
        """
